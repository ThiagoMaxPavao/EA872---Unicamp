...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_FIELD_SEPARATOR = 4,            /* FIELD_SEPARATOR  */
  YYSYMBOL_OPTION_SEPARATOR = 5,           /* OPTION_SEPARATOR  */
  YYSYMBOL_NEWLINE = 6,                    /* NEWLINE  */
  YYSYMBOL_WORD = 7,                       /* WORD  */
  YYSYMBOL_METODO = 8,                     /* METODO  */
  YYSYMBOL_YYACCEPT = 9,                   /* $accept  */
  YYSYMBOL_linhas = 10,                    /* linhas  */
  YYSYMBOL_linha = 11,                     /* linha  */
  YYSYMBOL_opcoes = 12,                    /* opcoes  */
  YYSYMBOL_13_opcoes_metodo = 13           /* opcoes-metodo  */
};
...
static const char *const yytname[] =
{
  ...
  "FIELD_SEPARATOR", "OPTION_SEPARATOR", "NEWLINE", "WORD", "METODO",
  "$accept", "linhas", "linha", "opcoes", "opcoes-metodo", YY_NULLPTR
};
